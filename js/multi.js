...
// Definir el emoji que representará los números
const emoji = "🍎";

// Función que genera una cadena de emojis en función de un número
function generarEmojis(num) {
    return emoji.repeat(num);  // Repite el emoji tantas veces como el valor de 'num'
}

// Función para comenzar el juego, generar una suma y actualizar la interfaz
function comenzar() {
    ...
    respuesta = num1 * num2;  // Calcular la respuesta correcta

    // Mostrar la operación con números
    txt_suma.innerHTML = `${num1} x ${num2} = `;

    // Mostrar la operación en emojis
    document.getElementById('emogi1').innerHTML = generarEmojis(num1);
    document.getElementById('emogi2').innerHTML = generarEmojis(num2);
    document.getElementById('emogi3').innerHTML = generarEmojis(respuesta);
